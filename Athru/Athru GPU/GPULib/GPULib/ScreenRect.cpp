...
ScreenRect::ScreenRect(const Microsoft::WRL::ComPtr<ID3D11Device>& d3dDevice)
{
...
void ScreenRect::PassToGPU(const Microsoft::WRL::ComPtr<ID3D11DeviceContext>& context)
{
